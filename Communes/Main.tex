...
\ontheright[0.7]{\SP{#3}}
\bottomright{\tiny\hyperlink{Beamer-Lausanne}{\nolinkurl{[retour]}}}
}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\stamp{
  ...
  \anywhere<3->[c]{0.7}{0.9}{\NewBox[redbox]{0.6}{\warningsign\ Il y a plus de listes modifiées PVL que Centre \Arrow Ça favorise nos candidats.}}
  \anywhere<4>[c]{0.5}{0.5}{\rotatebox{20}{\NewBox[textbox]{0.5}{Prenez ces chiffres avec précaution. C'est votre expertise locale qui compte.}}}
}
...
\Commune{Yverdon-les-Bains}{A Yverdon le Centre est fort (mais moins que nous) et leurs candidats populaires.\\ %\skipx 
  ...
  \hyperlink{BACKUP-Beamer-Chavannes-pres-Renens}{[Chavannes-près-Renens]} sont similaires.
...
\BadBad
\Commune{Payerne}{On est derrière le Centre!
  \skipx
